    ...
    EntityBall = ig.Entity.extend({
        ...
        update:function(){
			...
			if (this.gameControl.pause===false&&this.stick===false&&this.gameControl.delay===false&&this.gameControl.tutorialDone===true){
				...
				//console.log(this.gameControl.player.pos.y);
			...
			if (this.pos.y  > ig.system.height || this.pos.x < 40 - 14||this.pos.x > ig.system.width - 40|| this.pos.y < -14){
		...
		reStart:function(){
			...
			if (ig.ua.mobile){
				this.pos.y = 920 - this.size.y;
			}else{
				this.pos.y = this.gameControl.player.pos.y - this.size.y;
			}
			this.accVel.x = 400;
			this.accVel.y = 400;
		},
