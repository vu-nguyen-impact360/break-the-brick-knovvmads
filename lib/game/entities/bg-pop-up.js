...
.defines(function() {
    EntityBgPopUp = ig.Entity.extend({
        ...
        init:function(x,y,settings){
			...
			if (ig.ua.mobile){
				this.animSheet = new ig.AnimationSheet('media/graphics/game/background-m.png',540,960);
			}else{
				this.animSheet = new ig.AnimationSheet('media/graphics/game/background.png',960,540);
			}
