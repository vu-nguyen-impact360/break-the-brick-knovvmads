...
.defines(function() {
    EntityBlock = ig.Entity.extend({
        ...
        init:function(x,y,settings){
			...
			if(ig.ua.mobile) {
				this.parent(x*2, y*2 + 64, settings);
			} else {
			...
			this.addAnim('pink2', 0.1, [6]);
			this.addAnim('violet2', 0.1, [7]);
			this.addAnim('yellow2', 0.1, [8]);
			this.addAnim('red2', 0.1, [9]);
			this.addAnim('black2', 0.1, [10]);
