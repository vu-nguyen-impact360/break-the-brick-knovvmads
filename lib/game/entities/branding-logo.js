...
.defines(function() {
	...
	EntityBrandingLogo = ig.Entity.extend({
		logo: new ig.AnimationSheet('media/graphics/branding/logo.png',_SETTINGS['Branding']['Logo']['Width'],_SETTINGS['Branding']['Logo']['Height']),
		size:{x:_SETTINGS['Branding']['Logo']['Width'],
			y:_SETTINGS['Branding']['Logo']['Height'],
		},
		...
		createClickableOutboundLayer:function(id,outbound_link,image_path,open_new_window){			
			...
			$('#'+div.id).css('width',this.size.x*multiplier*1.2);
