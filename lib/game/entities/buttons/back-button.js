	...
	EntityBackButton = ig.Entity.extend({
		...
		update:function(){
			...
			if (this.gameControl.setting===true){
				...
				if (ig.ua.mobile){
					this.pos.x = this.settingPage.pos.x + (540 - 157)/2;
					this.pos.y = this.settingPage.pos.y + 600;
				}else{
					this.pos.x = this.settingPage.pos.x + (960 - 157)/2;
					this.pos.y = this.settingPage.pos.y + 540 - 157 - 40;
				}
