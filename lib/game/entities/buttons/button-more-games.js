...
.defines(function() {
	EntityButtonMoreGames = EntityButton.extend({
		...
		gravityFactor:0,
		logo: new ig.AnimationSheet('media/graphics/button/more-game-button.png',226,63),
		size:{x:226,y:63,},
		zIndex: 500,
		clickableLayer:null,
		link:null,
		...
		name:"moregames",
		pos: new Vector2(0,0),
		correctPos: new Vector2(960/2 + 226/2,540 - 122),
		...
		update:function(){
			...
			if (this.enable===true){
				...
				/*if (ig.ua.mobile){
					...
					this.pos.x = this.correctPosMoblie.x;
					this.pos.y = this.correctPosMoblie.y;
