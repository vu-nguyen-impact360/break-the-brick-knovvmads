...
.defines(function() {
	EntityButtonMoreGames = EntityButton.extend({
		...
		gravityFactor:0,
		logo: new ig.AnimationSheet('media/graphics/button/more-game-button.png', 452, 126),
		size:{x:452,y:126,},
		zIndex: 500,
		clickableLayer:null,
		link:null,
		...
		name:"moregames",
		pos: new Vector2(0,0),
		correctPos: new Vector2(1920/2 + 452/2 + 60,1080 - 244),
		correctPosMobile: new Vector2(1080/2 - 452/2,1500),
