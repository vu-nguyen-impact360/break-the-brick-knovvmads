		...
		update:function(){
			...
			if (this.pausePage.enable===true||this.resultPage.enable===true){
				...
				if (this.pausePage.enable===true){
					...
					if (ig.ua.mobile){
						this.pos.x = this.pausePage.pos.x + 360.5;
						this.pos.y = this.pausePage.pos.y + 569 + 50;
					}else{
						this.pos.x = this.pausePage.pos.x + 260 + 320;
					...
					if (ig.ua.mobile){
						this.pos.x = this.resultPage.pos.x + 540/2 + 5 + 10;
						this.pos.y = this.resultPage.pos.y + 680;
					}else{
						this.pos.x = this.resultPage.pos.x + 960/2 + 15;
