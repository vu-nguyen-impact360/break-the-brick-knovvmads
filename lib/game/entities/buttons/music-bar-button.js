			...
			if (this.enable===true){
				...
				if (this.pausePage.enable===true){
					if (ig.ua.mobile){
						...
						this.pos.y = this.pausePage.pos.y + (1920 - 348)/2  - 60*2 + 29*2 + 62.5*2;
					}else{
						this.pos.x = this.pausePage.pos.x + (1920 - 898)/2 + 86.5*2;
						this.pos.y = this.pausePage.pos.y + (1080 - 348)/2  - 40*2 + 29*2 + 62.5*2;
					}
					
				}else if (this.settingPage.enable===true){
					if (ig.ua.mobile){
						this.pos.x = this.settingPage.pos.x + (1080 - 898)/2 + 86.5*2;
						this.pos.y = this.settingPage.pos.y + (1920 - 348)/2  - 60*2 + 29*2 + 62.5*2;
					}else{
						this.pos.x = this.settingPage.pos.x + (1920 - 898)/2 + 86.5*2;
						this.pos.y = this.settingPage.pos.y + (1080 - 348)/2  - 40*2 + 29*2 + 62.5*2;
					}
