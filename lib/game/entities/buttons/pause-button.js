...
.defines(function() {
	EntityPauseButton = ig.Entity.extend({
		...
		clicked:function(){
			...
			if (this.state===false&&this.gameControl.countToPlay===false&&this.gameControl.delay===false){
		...
		update:function(){
			...
			if (this.gameControl.gameOver===true||this.gameControl.home===true||this.gameControl.setting===true){
