	...
	EntityPlayButton = ig.Entity.extend({
		...
		update:function(){
			...
			if (this.pausePage.enable===true){
				...
				if (ig.ua.mobile){
					this.pos.x = this.pausePage.pos.x + (1080 - 314)/2;
					this.pos.y = this.pausePage.pos.y + 1200;
				}else{
					this.pos.x = this.pausePage.pos.x + (1920 - 314)/2;
					this.pos.y = this.pausePage.pos.y + 1080 - 314 - 80;
				}
