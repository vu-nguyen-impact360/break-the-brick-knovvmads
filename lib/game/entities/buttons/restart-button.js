		...
		update:function(){
			...
			if (this.pausePage.enable===true||this.resultPage.enable===true){
				...
				if (this.pausePage.enable===true){
					...
					if (ig.ua.mobile){
						this.pos.x = this.pausePage.pos.x + 58*2;
						this.pos.y = this.pausePage.pos.y + 569*2 + 50*2;
					}else{
						this.pos.x = this.pausePage.pos.x +  260*2;
						this.pos.y = this.pausePage.pos.y + 540*2 - 119*2 - 60*2;
					}
					
				}else if (this.resultPage.enable===true){
					
					if (ig.ua.mobile){
						this.pos.x = this.resultPage.pos.x + 1080/2 - 119*2 - 10*2 ;
						this.pos.y = this.resultPage.pos.y + 680*2;
					}else{
						this.pos.x = this.resultPage.pos.x + 1920/2 - 119*2 - 5*2 - 15*2;
