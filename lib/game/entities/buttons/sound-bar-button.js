		...
		draw:function(){
			...
			if(this.enable===true){
				...
				if  (this.levle<1){
					...
					this.barImage.draw(this.pos.x,this.pos.y + 9.5,[0],[0],329,[31]);
				}else{
			...
			if (this.enable===true){
				...
				if (this.pausePage.enable===true){
					...
					if (ig.ua.mobile){
						...
						this.pos.y = this.pausePage.pos.y + (960 - 174)/2  - 60 + 29;
					}else{
					...
					if (ig.ua.mobile){
						...
						this.pos.y = this.settingPage.pos.y + (960 - 174)/2  - 60 + 29;
					}else{
						this.pos.x = this.settingPage.pos.x + (960 - 449)/2 + 86.5;
						this.pos.y = this.settingPage.pos.y + (540 - 174)/2  - 40 + 29;
					}
