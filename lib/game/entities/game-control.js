    ...
    EntityGameControl = ig.Entity.extend({
        ...
        draw:function(){
			...
			if (this.countToPlay===true){
				...
				if (this.timeCountToPlay>=0&&this.timeCountToPlay<30){
					
					ig.system.context.fillText("3",480,270 + 60);
					
				}else if (this.timeCountToPlay>=30&&this.timeCountToPlay<60){
					
					ig.system.context.fillText("2",480,270 + 60);
					
				}else if (this.timeCountToPlay>=60&&this.timeCountToPlay<90){
					
					ig.system.context.fillText("1",480,270 + 60);
					
				}else if (this.timeCountToPlay>60){
