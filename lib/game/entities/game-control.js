		...
		cloningBall:function(){
			...
			if (this.ballNumber<3){
				...
				if (this.ballNumber===1){
					...
					this.ball2AngleX = this.angleX - 0.5;
					if (this.ball2AngleX<-1){
						this.ball2AngleX = -1;
					}
					
					this.ball2AngleY = this.angleY - 0.5;
					if (this.ball2AngleY<-1){
						this.ball2AngleY = -1;
					}
					...
					this.ball3AngleX = this.angleX + 0.5;
					if (this.ball3AngleX>1){
						this.ball3AngleX = 1;
					}
					
					this.ball3AngleY = this.angleY + 0.5;
					if (this.ball3AngleY>1){
						this.ball3AngleY = 1;
					}
