    ...
    EntityGameControl = ig.Entity.extend({
        ...
        init:function(x,y,settings){
			...
			*/
			...
			// wall
			if (ig.ua.mobile){
				this.rightWall = ig.game.spawnEntity(EntityWallSide, 1000, 0,{gameControl:this,rightSide:true});
				
			}else{
				this.rightWall = ig.game.spawnEntity(EntityWallSide, 1920 - 80, 0,{gameControl:this,rightSide:true});
			}
