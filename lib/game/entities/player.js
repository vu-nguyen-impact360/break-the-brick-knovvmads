    ...
    EntityPlayer = ig.Entity.extend({
        ...
        draw:function(){
			...
			if (this.fire===true){
				...
				this.gunImage.draw(this.pos.x + this.size.x - this.size.x/4 + 18,this.pos.y - this.gunDeltaPosY);
		...
		firing:function(){
			...
			if (this.fireTime>=this.fireRate){
				...
				ig.game.spawnEntity(EntityBullet,this.pos.x + this.size.x/4 - 16, this.pos.y - 34,{gameControl:this.gameControl})
				ig.game.spawnEntity(EntityBullet,this.pos.x + this.size.x - this.size.x/4 + 16, this.pos.y - 34,{gameControl:this.gameControl})
