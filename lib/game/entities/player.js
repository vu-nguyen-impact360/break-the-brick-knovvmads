    ...
    EntityPlayer = ig.Entity.extend({
        ...
        draw:function(){
			if (this.fire===true){
				...
				this.gunImage.draw(this.pos.x + 50,this.pos.y - this.gunDeltaPosY);
				this.gunImage.draw((this.pos.x + this.size.x) - (36 + 50),this.pos.y - this.gunDeltaPosY);
		...
		firing:function(){
			...
			if (this.fireTime>=this.fireRate){
				...
				ig.game.spawnEntity(EntityBullet,this.pos.x + 50, this.pos.y - 34,{gameControl:this.gameControl})
				ig.game.spawnEntity(EntityBullet,(this.pos.x + this.size.x) - (36 + 50), this.pos.y - 34,{gameControl:this.gameControl})
