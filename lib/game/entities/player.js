    ...
    EntityPlayer = ig.Entity.extend({
		...
		move:function(){
			...
			if (this.gameControl.checkButton.pressed===true){
				...
				if (this.pointer.pos.x > this.pos.x - this.size.x/2 && this.pointer.pos.x < this.pos.x + this.size.x + this.size.x/2 && this.pointer.pos.y > this.pos.y - 50){
			...
			if (this.gameControl.checkButton.pressed===false){
		...
		firing:function(){
			...
			if (this.fireTimeCount>222){
				this.gunDeltaPosY += 1;
				if(this.gunDeltaPosY > 18){
					this.gunDeltaPosY = 18 ;
				}
				
			}else if (this.fireTimeCount<18){
				this.gunDeltaPosY -= 1;
