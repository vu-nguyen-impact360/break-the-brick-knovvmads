...
.defines(function() {
    EntityResultPage = ig.Entity.extend({
		...
		highScorePopup: new ig.Image('media/graphics/game/score-high.png'),
		gameControl:null,
        ...
        draw:function(){
			...
			if (this.enable===true){
				...
				if (ig.ua.mobile){
					...
					ig.system.context.fillText(_STRINGS.Results.Score,this.pos.x + (1080 - 595)*0.5 + 95,this.pos.y + 600 + 90);
					ig.system.context.fillText(_STRINGS.Results.HighScore,this.pos.x + (1080 - 595)*0.5 + 96,this.pos.y + 800 + 90);

					ig.system.context.fillText(this.gameControl.score,this.pos.x + (1080 - 595)*0.5 + 395,this.pos.y + 600 + 90);
					ig.system.context.fillText(this.gameControl.Highscore,this.pos.x + (1080 - 595)*0.5 + 395,this.pos.y + 800 + 90);
					...
					ig.system.context.fillText(_STRINGS.Results.Score,this.pos.x + (1920 - 595)*0.5 - 225,this.pos.y + (1080 - 152*2)/2 + 90);
					ig.system.context.fillText(_STRINGS.Results.HighScore,this.pos.x + (1920 - 595)*0.5 + 410,this.pos.y + (1080 - 152*2)/2 + 90);

					ig.system.context.fillText(this.gameControl.score,this.pos.x + (1920 - 595)*0.5 + 70,this.pos.y + (1080 - 152*2)/2 + 90);
					ig.system.context.fillText(this.gameControl.Highscore,this.pos.x + (1920 - 595)*0.5 + 710,this.pos.y + (1080 - 152*2)/2 + 90);
