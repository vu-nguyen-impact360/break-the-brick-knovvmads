        ...
        draw:function(){
			...
			if (this.enable===true){
				...
				if (ig.ua.mobile){
					...
					ig.system.context.fillText("GAME OVER",this.pos.x + 270,this.pos.y + 240);
				
				
					this.imagePopUpMobile.draw(this.pos.x + (540 - 451)/2,this.pos.y + (960 - 367)/2);
					...
					ig.system.context.fillText(this.gameControl.score,this.pos.x + (540)/2,this.pos.y + 430);
				
					ig.system.context.fillStyle = "#6D637A";   // set font colour
					ig.system.context.fillText(this.gameControl.Highscore,this.pos.x + (540)/2,this.pos.y + 630);
					
					
				}else{
					
					ig.system.context.fillText("GAME OVER",this.pos.x + 480,this.pos.y + 100);
				
				
					this.imagePopUp.draw(this.pos.x + (960 - 799)/2,this.pos.y + (540 - 152)/2 - 35);
					...
					ig.system.context.fillStyle = "#FEF8F7";   // set font colour
					ig.system.context.fillText(this.gameControl.score,this.pos.x + (960 - 799)/2 + 200,this.pos.y + (540 - 152)/2 + 123 - 35);
				
					ig.system.context.fillStyle = "#6D637A";   // set font colour
					ig.system.context.fillText(this.gameControl.Highscore,this.pos.x + (960 - 799)/2 + 610,this.pos.y + (540 - 152)/2 + 123 - 35);
