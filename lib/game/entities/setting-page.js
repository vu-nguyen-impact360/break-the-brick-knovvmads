    ...
    EntitySettingPage = ig.Entity.extend({
        ...
        draw:function(){
			...
			if (this.enable===true){
				...
				if (ig.ua.mobile){
					ig.system.context.fillText("SETTINGS",this.pos.x + 270*2,this.pos.y + 240*2);
					...
					// this.imagePopUp.draw(this.pos.x + (1080 - 674)/2 ,this.pos.y + (1920 - 348)/2  - 60*2);
				}else{
					ig.system.context.fillText("SETTINGS",this.pos.x + 480*2,this.pos.y + 100*2);
				
					// this.imagePopUp.draw(this.pos.x + (1920 - 674)/2 ,this.pos.y + (1080 - 348)/2  - 40*2);
