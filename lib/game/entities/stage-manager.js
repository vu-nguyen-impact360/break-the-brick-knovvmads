...
.defines(function() {
    EntityStageManager = ig.Entity.extend({
        ...
        update:function(){
			...
			if (this.gameControl.blockNumber<=0 && this.reStart===false && this.gameControl.home===false){
		...
		stage01:function(){
			...
			ig.game.spawnEntity(EntityBlock,450,50 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
			ig.game.spawnEntity(EntityBlock,450,50 + 32 + 12,{gameControl:this.gameControl,color:"red",hp:2});
			ig.game.spawnEntity(EntityBlock,450,50 + 32 + 32 + 12,{gameControl:this.gameControl,color:"black",hp:2});
			ig.game.spawnEntity(EntityBlock,450,50 + 32 + 32 + 32 + 12 ,{gameControl:this.gameControl,color:"yellow",hp:2});
			ig.game.spawnEntity(EntityBlock,450,50 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"violet",hp:2});
			ig.game.spawnEntity(EntityBlock,450,50 + 32 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
			
			ig.game.spawnEntity(EntityBlock,300,50 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
			ig.game.spawnEntity(EntityBlock,300,50 + 32 + 12,{gameControl:this.gameControl,color:"red",hp:2});
			ig.game.spawnEntity(EntityBlock,300,50 + 32 + 32 + 12,{gameControl:this.gameControl,color:"black",hp:2});
			ig.game.spawnEntity(EntityBlock,300,50 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"yellow",hp:2});
			ig.game.spawnEntity(EntityBlock,300,50 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"violet",hp:2});
			ig.game.spawnEntity(EntityBlock,300,50 + 32 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
			
			ig.game.spawnEntity(EntityBlock,600,50 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
			ig.game.spawnEntity(EntityBlock,600,50 + 32 + 12,{gameControl:this.gameControl,color:"red",hp:2});
			ig.game.spawnEntity(EntityBlock,600,50 + 32 + 32 + 12,{gameControl:this.gameControl,color:"black",hp:2});
			ig.game.spawnEntity(EntityBlock,600,50 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"yellow",hp:2});
			ig.game.spawnEntity(EntityBlock,600,50 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"violet",hp:2});
			ig.game.spawnEntity(EntityBlock,600,50 + 32 + 32 + 32 + 32 + 32 + 12,{gameControl:this.gameControl,color:"pink",hp:2});
