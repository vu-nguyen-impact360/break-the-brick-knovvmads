...
.defines(function() {
    EntityTestControl = ig.Entity.extend({
        ...
        spawnTweenEntity: function() {
            this.tweenEntity = ig.game.spawnEntity(EntityTest,600,50, { control: this, color: new ColorRGB(255,125,125,1) });
        ...
        spawnTweenControlButtons: function() {
            this.tweenControlButtons = {
                ...
                start   : ig.game.spawnEntity( EntityButton, 500, 50, { control: this, color: new ColorRGB(255,125,125,1) }),
                stop    : ig.game.spawnEntity( EntityButton, 500, 100, { control: this, color: new ColorRGB(255,125,125,1) }),
                pause   : ig.game.spawnEntity( EntityButton, 500, 150, { control: this, color: new ColorRGB(255,125,125,1) }),
                resume  : ig.game.spawnEntity( EntityButton, 500, 200, { control: this, color: new ColorRGB(255,125,125,1) }),
                end     : ig.game.spawnEntity( EntityButton, 500, 250, { control: this, color: new ColorRGB(255,125,125,1) })               
            };
        ...
        setupTweenControlButtons: function() {
            ...
            for(buttonKey in this.tweenControlButtons) {
                ...
                buttonEntity.draw = function() {
                    ...
                    ig.system.context.fillText( this.name, this.pos.x+0.5*this.size.y, this.pos.y+0.5*this.size.y );
                };
            }
