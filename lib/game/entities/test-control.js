...
.defines(function() {
    EntityTestControl = ig.Entity.extend({
        ...
        spawnTweenEntity: function() {
            this.tweenEntity = ig.game.spawnEntity(EntityTest,595,49, { control: this, color: new ColorRGB(255,125,125,1) });
            
            this.tweenControl = new ig.TweenDef(this.tweenEntity.pos).to({ y: 280 }, 5000);
        },
        
        spawnTweenControlButtons: function() {
            this.tweenControlButtons = {
                
                start   : ig.game.spawnEntity( EntityButton, 500, 50, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),
                stop    : ig.game.spawnEntity( EntityButton, 500, 100, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),
                pause   : ig.game.spawnEntity( EntityButton, 500, 150, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),
                resume  : ig.game.spawnEntity( EntityButton, 500, 200, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),
                end     : ig.game.spawnEntity( EntityButton, 500, 250, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),               
                pGame : ig.game.spawnEntity( EntityButton, 500, 300, { control: this, size: new Vector2(68,48), color: new ColorRGB(255,125,125,1) }),          
            };
