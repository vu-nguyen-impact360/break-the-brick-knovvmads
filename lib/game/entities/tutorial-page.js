...
.defines(function() {
    EntityTutorialPage = ig.Entity.extend({
        ...
        update:function(){
			...
			if (this.gameControl.tutorialDone===false&&this.gameControl.home===false){
        ...
        draw:function(){
			...
			if (this.enable===true){
				...
				if (this.gameControl.tutorialIndex===1){
						...
						ig.system.context.fillText("1",480,100);
					
				}else if (this.gameControl.tutorialIndex===1){
					
						ig.system.context.fillText("2",480,100);
