        ...
        update:function(){
			...
			if  (this.gameControl.tutorialIndex===2) {
				...
				if (ig.ua.mobile){
					...
					if (this.handMove=== true&&this.handPosX<640){
					...
					if (this.handMove===false&&this.playerMove===false)
					{
						...
						this.playerPosX -= this.playerSpeed;
						if (this.playerPosX <= 340){
							//this.playerMove = false;
							this.playerPosX = 340;
						
						}
					
						if (this.handPosX===340&&this.playerPosX===340){
							this.handMove = true;
						}
        ...
        draw:function(){
			...
			if (this.enable===true){
				...
				if (ig.ua.mobile){ 
					...
					ig.system.context.fillText("TUTORIAL",270,240);
					// page of tutorial
					...
					if (this.gameControl.tutorialIndex===1){
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial01_01,270,425);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial02_03,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial02_02,270,425);
						
							this.imagePlayer.draw(this.playerPosX - 117/2 - 210,this.playerPosY + 285);
							this.imageHand.draw(this.handPosX - 25 - 210,this.handPosY + 285);
							
						ig.system.context.fillStyle = "#7E6E8A";   // set font colour
						ig.system.context.font = "16px Champ";   // set font
						ig.system.context.textAlign = 'center';
				
						ig.system.context.fillText(_STRINGS.Game.Next,435,475);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial03_01,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial03_02,270,425);
							ig.system.context.fillText(_STRINGS.Game.toturial03_03,270,455);
						
							this.imageBall.draw(this.ball1.x - 210,this.ball1.y + 285);
							this.imageBall.draw(this.ball2.x - 210,this.ball2.y + 285);
							this.imageBall.draw(this.ball3.x - 210,this.ball3.y + 285);
							this.imagePlayer.draw(450 - 210,450 + 285);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial04_01,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial04_02,270,425);
							ig.system.context.fillText(_STRINGS.Game.toturial04_03,270,455);
						
							this.imageBlack1.draw(this.black1.x - 210 - 50,this.black1.y + 285);
							this.imageBlack2.draw(this.black2.x - 210 - 50,this.black2.y + 285);
						
							if (this.hited1===false){
							
								this.imageBlack3.draw(this.black3.x - 210 - 50,this.black3.y + 285);
							
							}else {
							
								this.imageBlack4.draw(this.black4.x - 210 - 50,this.black4.y + 285);
							
							}
						
							if (this.hited2===false){
							
								this.imageBlack5.draw(this.black5.x - 210 - 50,this.black5.y + 285);
							
							}
						
							this.imageBall.draw(this.ballPage4.x - 210 - 50,this.ballPage4.y + 285);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial05_01,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial05_02,270,425);
							ig.system.context.fillText(_STRINGS.Game.toturial05_03,270,455);
						
							this.imageIron.draw(310 - 210,330 + 285);
							this.imageIron.draw(370 - 210,330 + 285);
							this.imageIron.draw(430 - 210,330 + 285);
							this.imageIron.draw(490 - 210,330 + 285);
							this.imageIron.draw(550 - 210,330 + 285);
							this.imageIron.draw(610 - 210,330 + 285);
						
							this.imageBall.draw(this.ballPage5.x - 210,this.ballPage5.y + 285);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial06_01,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial06_02,270,425);
							ig.system.context.fillText(_STRINGS.Game.toturial06_03,270,455);
						
							this.imageItem1.draw(this.itemPos1.x - 210,this.itemPos1.y + 285);
							this.imageItem2.draw(this.itemPos2.x - 210,this.itemPos2.y + 285);
							this.imageItem3.draw(this.itemPos3.x - 210,this.itemPos3.y + 285);
							this.imageItem4.draw(this.itemPos4.x - 210,this.itemPos4.y + 285);
						...
						ig.system.context.textAlign = 'center';
							...
							ig.system.context.fillText(_STRINGS.Game.toturial07_01,270,395);
							ig.system.context.fillText(_STRINGS.Game.toturial07_02,270,425);
					...
					if (this.gameControl.tutorialIndex===1){
						...
						ig.system.context.fillText(_STRINGS.Game.Next,665,285);
