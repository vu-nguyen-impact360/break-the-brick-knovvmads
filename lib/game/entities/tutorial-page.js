			...
			if (this.enable===true){
				...
				if (ig.ua.mobile){ 
					...
					if (this.gameControl.tutorialIndex===1){
						...
						ig.system.context.fillStyle = "#7E6E8A";   // set font colour
						ig.system.context.font = "80px Champ";   // set font
						ig.system.context.textAlign = 'center';
						...
						ig.system.context.fillStyle = "#7E6E8A";   // set font colour
						ig.system.context.font = "32px Champ";   // set font
						ig.system.context.textAlign = 'center';
				
						ig.system.context.fillText(_STRINGS.Game.Next,435*2,475*2);
							
					
					}else if  (this.gameControl.tutorialIndex===3) {
						ig.system.context.fillStyle = "#7E6E8A";   // set font colour
						ig.system.context.font = "40px Champ";   // set font
						ig.system.context.textAlign = 'center';
					...
					if (this.gameControl.tutorialIndex===1){
						...
						ig.system.context.fillText(_STRINGS.Game.Next,665*2,285*2);
