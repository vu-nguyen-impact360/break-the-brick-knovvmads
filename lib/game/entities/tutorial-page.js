			...
			if (this.enable===true){
				...
				if (this.gameControl.tutorialIndex===1){
					...
					ig.system.context.textAlign = 'center';
						...
						ig.system.context.fillText("when ball hited a bar",480,190);
						ig.system.context.fillText("it will reflected from the center point of a bar ",480,220);
						ig.system.context.fillText("so, you can control a direction of ball ",480,250);
					...
					ig.system.context.textAlign = 'center';
						...
						ig.system.context.fillText("hit a block with ball to get a scare",480,190);
						ig.system.context.fillText("twice time to break a normal block ",480,220);
						ig.system.context.fillText("and once time to break a breaken block  ",480,250);
					...
					ig.system.context.textAlign = 'center';
						...
						ig.system.context.fillText("iron block it can not breaking",480,190);
						ig.system.context.fillText("furthermore, acceleration of ball is increase ",480,220);
						ig.system.context.fillText("when you hit it, be carefull ",480,250);
						...
						//this.imageBall.draw(this.ballPage4.x,this.ballPage5.y);
