...
.defines(function() {
    EntityUi = ig.Entity.extend({
        ...
        draw:function(){
			...
			if (this.gameControl.countToPlay===true){
			...
			if ( (this.gameControl.pause===false||this.gameControl.countToPlay===true)&&this.gameControl.gameOver===false&&this.gameControl.home===false&&this.gameControl.setting===false ){
