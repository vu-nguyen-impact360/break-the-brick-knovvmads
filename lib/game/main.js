...
.defines(function(){	
	...
	MyGame = ig.Game.extend({	
		...
		draw: function(){
			...
			//hold click on screen for 3s to enable 
			this.drawDebug();
		},
		...
		debugEnable: function(){	// enable debug  
			//hold on screen for more than 3s then can enable debug
			if(ig.input.pressed('click')){
				this.debugTimer = new ig.Timer(3);
			}
			if(this.debugTimer && this.debugTimer.delta() < 0){
