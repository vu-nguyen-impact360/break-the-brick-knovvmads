...
.defines(function(){	
	...
	MyGame = ig.Game.extend({	
		...
		initSfx: function(){
			//play sfx example   ---    ig.game.staticSound.play();
			ig.game.staticSound = new Howl({urls:['media/audio/play/static.ogg','media/audio/play/static.mp3']});
			ig.game.openingSound = new Howl({urls:['media/audio/opening/opening.ogg','media/audio/opening/opening.mp3']});	
