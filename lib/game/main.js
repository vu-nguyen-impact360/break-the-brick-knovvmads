...
.defines(function(){	
	...
	MyGame = ig.Game.extend({	
		...
		setupMarketJSAPI:function(){
			MarketJS.Initialize('ahVzfm1hcmtldGpzLWdhbWVjZW50ZXJyFQsSCFVzZXJHYW1lGICAgIDAnKoJDA');
		},
	...
	window.onunload = window.onbeforeunload = function(){
		MarketJS.SingleMetric.Write('ExitGameTotalTime',TIME_SPENT);
		MarketJS.SingleMetric.Write('ExitGame',1);
	}
