    ...
    ig.SoundHandler = ig.Class.extend({
        ...
        init: function() {
            ...
            else // Desktop
            {
                ...
                //this.bgmPlayer = new JukeboxPlayer(soundList.bgm,{loop:true});
                //this.bgmPlayer = new ImpactMusicPlayer(soundList.bgm,{loop:true});
                //this.sfxPlayer = new ImpactSoundPlayer(soundList.sfx);
                this.sfxPlayer = new HowlerPlayer(this.soundInfo.sfx);
                //this.bgmPlayer.play();
            }
        },
        ...
        unlockWebAudio: function() {
            ...
            if (ig.soundHandler.bgmPlayer.webaudio && ig.soundHandler.bgmPlayer.webaudio.context) {
                if (ig.soundHandler.bgmPlayer.webaudio.context.state && ig.soundHandler.bgmPlayer.webaudio.context.state !== "running") {
