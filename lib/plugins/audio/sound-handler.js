...
.defines(function(){
    ig.SoundHandler = ig.Class.extend({
        ...
        muteAll:function(bool)
        {
            if(this.bgmPlayer)
            {
                this.bgmPlayer.mute({flagChange:bool});
            }
            if(this.sfxPlayer)
            {
                this.sfxPlayer.mute({flagChange:bool});
            }
        ...
        unmuteAll:function(bool)
        {
            if(this.bgmPlayer)
            {
                this.bgmPlayer.unmute({flagChange:bool});
            }
            if(this.sfxPlayer)
            {
                this.sfxPlayer.unmute({flagChange:bool});
            }
        },
        ...
        forceUnMuteAll:function()
        {
            console.log(this.focusBlurMute)
            if(this.focusBlurMute)
            {
                this.unmuteAll();
                this.focusBlurMute=false;
