...
.defines(function() {
    ...
    *
    * var coords = { x: 0, y: 0 };
    * var tween = new ig.TweenDef.Tween(coords)
    * 	.to({ x: 100, y: 100 }, 1000)
    * 	.onUpdate(function() {
    ...
    */
    ...
    ig.Tween.Interpolation = {
    	Linear: function (v, k) {
    		...
    		var f = m * k;
    		var i = Math.floor(f);
    		var fn = ig.TweenDef.Interpolation.Utils.Linear;
    	...
    	Bezier: function (v, k) {
    		...
    		var n = v.length - 1;
    		var pw = Math.pow;
    		var bn = ig.TweenDef.Interpolation.Utils.Bernstein;
    	...
    	CatmullRom: function (v, k) {
    		...
    		var f = m * k;
    		var i = Math.floor(f);
    		var fn = ig.TweenDef.Interpolation.Utils.CatmullRom;
    	...
    	Utils: {
    		...
    		Bernstein: function (n, i) {
    			...
    			var fc = ig.TweenDef.Interpolation.Utils.Factorial;
    ...
    ig.game.Tween = ig.Class.extend({
        ...
        ig.TweenDef.Tween = function (object) {
